...
namespace StatePipes.ServiceCreatorTool
{
    ...
    {
        public static void LaunchSolution(string solutionFullPath) => LaunchVsDte(isPreRelease: false, arguments: solutionFullPath);
        private static void LaunchVsDte(bool isPreRelease, string arguments)
        {
